...
const dataset = [
  ...
  { min: -11, max: -3, precip: 66, month: "Fev" },
  ...
  { min: 17, max: 26, precip: 105, month: "Ago" },
  { min: 13, max: 21, precip: 100, month: "Set" },
  { min: 6, max: 13, precip: 116, month: "Out" },
  { min: 0, max: 6, precip: 93, month: "Nov" },
  { min: -8, max: -1, precip: 93, month: "Dez" },
];
    ...
    <Stack sx={{ width: "100%" }}>
      ...
      <Box sx={{ width: "100%" }}>
        ...
        >
          ...
          <ChartsXAxis />
          <ChartsYAxis axisId="leftAxis" label="Vendas" />
          {/* <ChartsYAxis
            axisId="rightAxis"
            position="right"
            label=""
